...
@section('page-subtitle', 'Update product details and stock information.')

@section('content')
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow">
    <h2 class="text-2xl font-semibold mb-6 text-indigo-700">Edit Product</h2>
    ...
    <form action="{{ route('inventory.update', $inventory->id) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="category" id="category" value="{{ old('category', $inventory->category) }}"
                   class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring focus:ring-indigo-200"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="price" id="price" step="0.01" value="{{ old('price', $inventory->price) }}"
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring focus:ring-indigo-200"
